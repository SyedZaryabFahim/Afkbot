...
async def handle_message(event):
  ...
  # Handle /start command
    ...
    start_text = (
        "🌙 **Welcome to AFK Bot!** 💬\n\n"
        "I help you manage AFK (Away From Keyboard) status easily.\n"
        "You can set yourself AFK, choose funny reasons, and even auto-notify "
        "others when they mention you while you’re away! 💤\n\n"
        "✨ **Commands:**\n"
        "• `/afk [reason]` – Set yourself as AFK.\n"
        "• `brb [reason]` – Same as AFK.\n"
        "• `/safk` – Toggle special AFK mode (admin only).\n"
        "• `/help` – Show help menu.\n\n"
        "Enjoy your peace while I handle your AFK messages! 😴"
    )
